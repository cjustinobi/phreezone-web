...
<!--              <strong>Phone:</strong> +234 708 4238 234<br>-->
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <nuxt-link to="/">Home</nuxt-link></li>
              <li><i class="bx bx-chevron-right"></i> <nuxt-link to="/about">About us</nuxt-link></li>
              <li><i class="bx bx-chevron-right"></i> <nuxt-link to="/contact">Contact Us</nuxt-link></li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <p>Join the conversation on all our social media handle</p>
